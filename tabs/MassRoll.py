...
def MassRoll(RelPosMassroll, RelPosMonsters) -> None:
    ...
    mass_save_description_label = tk.Label(GSM.Mass_roll_frame, text="FIREEBAAAAALLL!!")
    mass_save_description_label.place(x=RelPosMassroll.same("x"), y=RelPosMassroll.increase("y", 35))
    #Saving throw modifier
    mass_save_mod_text_label = tk.Label(GSM.Mass_roll_frame, text="Saving throw mod:  +")
    mass_save_mod_text_label.place(x=RelPosMassroll.same("x"), y=RelPosMassroll.increase("y", 30))
    ...
    mass_skill_check_label = tk.Label(GSM.Mass_roll_frame, text="Mass skill check", font=GSM.Title_font)
    mass_skill_check_label.place(x=RelPosMassroll.set("x", 220), y=RelPosMassroll.reset("y"))

    mass_skill_description_label = tk.Label(GSM.Mass_roll_frame, text="Useful when you want to secretely roll a lot\n"
                                                                      "of skill checks, such as to spot traps, hidden\n"
                                                                      "units, presence of magic, or insight checks")
    mass_skill_description_label.place(x=RelPosMassroll.same("x"), y=RelPosMassroll.increase("y", 35))

    #Create boxes to enter modifiers
    RelPosMassroll.increase("y", 35)
    ...
    skill_name_text_label.place(x=RelPosMassroll.same("x"), y=RelPosMassroll.increase("y", 23))
    ...
    for i in range(10):
        ...
        mass_skill_name_entry.place(x=RelPosMassroll.set("x", 220), y=RelPosMassroll.increase("y", 28))
        ...
        mass_skill_mod_spinbox.place(x=RelPosMassroll.set("x", 292), y=RelPosMassroll.same("y"))
        ...
        mass_skill_rolltype_dropdown.place(x=RelPosMassroll.set("x", 335), y=RelPosMassroll.increase("y", -4))
        ...
        mass_skill_enable_checkbox.place(x=RelPosMassroll.set("x", 435), y=RelPosMassroll.same("y"))
    ...
    mass_skill_dc_text_label.place(x=RelPosMassroll.set("x", 220), y=RelPosMassroll.increase("y", 30))
    ...
    mass_skill_check_button = tk.Button(GSM.Mass_roll_frame, text="Mass skill check", state="normal", command=RollMassSkillButton,
                                 padx=9, background="grey")
    mass_skill_check_button.place(x=RelPosMassroll.same("x"), y=RelPosMassroll.increase("y", RelPosMassroll.constant_y))
