...
def Attack(RelPosROLL):
    ...
    def OneAttack() -> None:
        ...
        attacker_dropdown = tk.OptionMenu(GSM.Attack_frame, GSM.OneAttacker_pointer, *GSM.Monsters_list)
        GSM.OneAttacker_pointer.set(GSM.Monsters_list[0])
        ...
        defender_dropdown = tk.OptionMenu(GSM.Attack_frame, GSM.OneDefender_pointer,
    ...
    Oneattack_button = tk.Button(GSM.Attack_frame, text="Attack once", state="normal", command=OneAttack,
                            font=GSM.Target_font, padx=3, background="grey")
